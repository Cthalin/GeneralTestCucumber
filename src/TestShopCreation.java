...
public class TestShopCreation {
    ...
    public void createShop(WebDriverWait wait, WebDriver driver, TestData testData) throws InterruptedException {
    ...
    public void deleteShop(WebDriverWait wait, WebDriver driver){
